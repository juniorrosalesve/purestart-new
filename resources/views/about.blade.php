...
@section('body')
    ...
    <div class="bg-primary text-center py-20 md:p-20 w-full" data-aos="fade-right">
    ...
    <div class="bg-secondary w-full" style="z-index: 100;">
        <br /> 
        <div class="w-full text-center mb-60" data-aos="fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 bg-white md:max-h-[1000px]">
        ...
        <div class="w-[90%] mt-10 mx-auto md:ml-8">
            ...
            <p class="profile text-2xl">Hey, I’m Valentina. I am a citrus lover, sport obhsessed and an art and craft genius.</p>
            <p class="profile text-2xl mt-8">I decided to create PURESTART in light of te fact of my desire and motivation to dive into the entrepreneurial world. </p>
            <p class="profile text-2xl mt-8">Currently using my corporate background, my experience in customer service, and my passion for cleaning, for my business.</p>
            <p class="profile text-2xl mt-8">I grew up with high standards of cleaning.</p>
            <p class="profile text-2xl mt-8">My home was always in order. I was taught step by step how to wash the dishes, specially if eggs were part of the meal. I watched my mom making the beds with such a technic. She would also iron sheets and towels! I know, kind of  crazy!! But I have to admit, they would look different once stored. </p>
            <p class="profile text-2xl mt-8">For all of the above, I took the leap of faith to make this project happen and it has been the greatest adventure yet. I absolutely love what I do, and what I do it for. I cant wait to meet you and have you as part of my happy customers!!   </p>
            <h1 class="text-3xl mt-10 mb-10 md:mb-36 md:mt-10 text-center profile" style="letter-spacing: 3px;">It is a great pleasure to meet you!</h1>
        </div>
    </div>
    ...
    <div class="bg-primary h-auto md:h-96 z-10">
        <br />
